...
- calculer ("calculate") la <span style="background-color: #ffdfba; padding: 2px;">distribution de la statistique sous hypothèse nulle</span>
- calculer ("calculate") la <span style="background-color: #ffdfba; padding: 2px;">statistique observée</span>
- obtenir la <span style="background-color: #ffb3ba; padding: 2px;">p-value</span> ("get_p_value") et l'interpréter
...
ggplot(broceliande,
  ...
  geom_boxplot(width=0.3)+
  geom_violin(fill="#A03090", alpha=0.5)+
  labs(title = "fees~enchantement",
       x = "enchantement", y = "fees") +
  scale_y_sqrt()+
  theme_minimal()
```
</td></tr></table>
